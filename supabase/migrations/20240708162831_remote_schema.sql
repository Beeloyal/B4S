...
CREATE OR REPLACE FUNCTION "public"."check_transaction_units"() RETURNS "trigger"
  ...
  value bigint;
begin
  if new.status = 'completed'::transaction_status
  then
    select id into value from transaction_units where id = new.transaction AND status != 'completed'::transaction_status limit 1;
...
CREATE OR REPLACE FUNCTION "public"."employer_has_permissions"("localid" integer) RETURNS boolean
    LANGUAGE "sql"
    AS $$
  SELECT current_setting('request.jwt.raw_user_meta_data'::text, true)::json ->> 'selected_local'::text = localId::text AND current_setting('request.headers'::text, true)::json ->> 'client'::text = 'app.beeloyal.employer'::text;
$$;

ALTER FUNCTION "public"."employer_has_permissions"("localid" integer) OWNER TO "postgres";

CREATE OR REPLACE FUNCTION "public"."employer_has_permissions"("localid" "text") RETURNS boolean
    LANGUAGE "sql"
    AS $$
  (SELECT current_setting('request.jwt.raw_user_meta_data'::text, true)::json ->> 'selected_local'::text = localId AND current_setting('request.headers'::text, true)::json ->> 'client'::text = 'app.beeloyal.employer'::text);
$$;

ALTER FUNCTION "public"."employer_has_permissions"("localid" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."local_details" (
    "id" integer NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."local_details" OWNER TO "postgres";

ALTER TABLE "public"."local_details" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."local_details_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."local_urls" (
    "id" integer NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
...
ALTER TABLE "public"."local_urls" OWNER TO "postgres";

ALTER TABLE "public"."local_urls" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."local_urls_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."local_details"
    ADD CONSTRAINT "local_details_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."local_urls"
    ADD CONSTRAINT "local_urls_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."employees"
    ADD CONSTRAINT "employees_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."local_addresses"
    ADD CONSTRAINT "public_local_addresses_details_fkey" FOREIGN KEY ("details") REFERENCES "public"."local_details"("id") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."local_addresses"
    ADD CONSTRAINT "public_local_addresses_local_fkey" FOREIGN KEY ("local") REFERENCES "public"."locals"("id") ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."local_details"
    ADD CONSTRAINT "public_local_details_local_fkey" FOREIGN KEY ("local") REFERENCES "public"."locals"("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ONLY "public"."local_details"
    ADD CONSTRAINT "public_local_details_urls_fkey" FOREIGN KEY ("urls") REFERENCES "public"."local_urls"("id") ON UPDATE CASCADE ON DELETE SET NULL;

ALTER TABLE ONLY "public"."local_urls"
    ADD CONSTRAINT "public_local_urls_local_fkey" FOREIGN KEY ("local") REFERENCES "public"."locals"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "Employees select company data" ON "public"."companies" FOR SELECT USING (((( SELECT "auth"."uid"() AS "uid") IN ( SELECT "employees"."user_id"
   FROM "public"."employees"
  WHERE ("employees"."company" = "employees"."id"))) AND "public"."is_employer_app"()));
...
CREATE POLICY "Employer" ON "public"."customers" FOR SELECT USING ((("local" = ( SELECT "local_addresses"."local"
  ...
  WHERE ("local_addresses"."id" = ( SELECT "employees"."local_address"
           FROM "public"."employees"
          WHERE ("employees"."user_id" = ( SELECT "auth"."uid"() AS "uid")))))) AND "public"."is_employer_app"()));
...
CREATE POLICY "Employer permissions" ON "public"."transaction_units" FOR INSERT WITH CHECK (((( SELECT "auth"."uid"() AS "uid") IN ( SELECT "employees"."user_id"
   FROM "public"."employees"
...
CREATE POLICY "Employer select" ON "public"."accounts" FOR SELECT USING ((( SELECT "employees"."id"
   FROM "public"."employees"
  WHERE ("employees"."user_id" = ( SELECT "auth"."uid"() AS "uid"))) IS NOT NULL));
...
CREATE POLICY "Employer update" ON "public"."transaction_units" FOR UPDATE USING (((( SELECT "auth"."uid"() AS "uid") = ( SELECT "employees"."user_id"
   FROM "public"."employees"
  WHERE ("employees"."id" = ( SELECT "transactions"."employer"
           FROM "public"."transactions"
          WHERE ("transactions"."id" = "transaction_units"."transaction"))))) AND "public"."is_employer_app"()));

CREATE POLICY "Employer with permission" ON "public"."transaction_units" FOR SELECT USING ((( SELECT "auth"."uid"() AS "uid") IN ( SELECT "employees"."user_id"
   FROM "public"."employees"
  WHERE ("employees"."id" = ( SELECT "transactions"."employer"
           FROM "public"."transactions"
...
CREATE POLICY "Enable read access for all users" ON "public"."local_details" FOR SELECT USING (true);

CREATE POLICY "Enable read access for all users" ON "public"."local_urls" FOR SELECT USING (true);
...
CREATE POLICY "Enable select for users based on user_id" ON "public"."employees" FOR SELECT TO "authenticated" USING ((( SELECT "auth"."uid"() AS "uid") = "user_id"));
...
CREATE POLICY "Policy with table employer insert" ON "public"."transactions" FOR INSERT WITH CHECK (((( SELECT "auth"."uid"() AS "uid") IN ( SELECT "employees"."user_id"
   FROM "public"."employees"
...
CREATE POLICY "employer with select permission" ON "public"."transactions" FOR SELECT USING ((( SELECT "auth"."uid"() AS "uid") IN ( SELECT "employees"."user_id"
   FROM "public"."employees"
...
ALTER TABLE "public"."local_details" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."local_urls" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."employer_has_permissions"("localid" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."employer_has_permissions"("localid" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."employer_has_permissions"("localid" integer) TO "service_role";

GRANT ALL ON FUNCTION "public"."employer_has_permissions"("localid" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."employer_has_permissions"("localid" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."employer_has_permissions"("localid" "text") TO "service_role";
...
GRANT ALL ON TABLE "public"."local_details" TO "anon";
GRANT ALL ON TABLE "public"."local_details" TO "authenticated";
GRANT ALL ON TABLE "public"."local_details" TO "service_role";

GRANT ALL ON SEQUENCE "public"."local_details_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."local_details_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."local_details_id_seq" TO "service_role";

GRANT ALL ON TABLE "public"."local_urls" TO "anon";
GRANT ALL ON TABLE "public"."local_urls" TO "authenticated";
GRANT ALL ON TABLE "public"."local_urls" TO "service_role";

GRANT ALL ON SEQUENCE "public"."local_urls_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."local_urls_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."local_urls_id_seq" TO "service_role";
