...
CREATE TABLE IF NOT EXISTS "public"."local_posts" (
    "id" integer NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "local" integer NOT NULL,
    "creator" "uuid",
    ...
    "image_url" "text",
    "channels" "public"."channel"[] NOT NULL
);


ALTER TABLE "public"."local_posts" OWNER TO "postgres";


ALTER TABLE "public"."local_posts" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."local_posts_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."local_posts"
    ADD CONSTRAINT "local_posts_pkey" PRIMARY KEY ("id");
...
CREATE OR REPLACE TRIGGER "local_post_notification" AFTER INSERT ON "public"."local_posts" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://cfrwepxesctjdwtkmfas.supabase.co/functions/v1/postNotification', 'POST', '{"Content-type":"application/json"}', '{}', '5000');
...
CREATE OR REPLACE TRIGGER "reward_confirmation_request_notification" AFTER UPDATE ON "public"."transaction_units" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://cfrwepxesctjdwtkmfas.supabase.co/functions/v1/rewardConfirmationRequestNotification', 'POST', '{"Content-type":"application/json"}', '{}', '5000');



CREATE OR REPLACE TRIGGER "transaction_completed_notification" AFTER UPDATE ON "public"."transactions" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://cfrwepxesctjdwtkmfas.supabase.co/functions/v1/transactionCompletedNotification', 'POST', '{"Content-type":"application/json"}', '{}', '5000');
...
ALTER TABLE ONLY "public"."local_posts"
    ADD CONSTRAINT "local_posts_creator_fkey" FOREIGN KEY ("creator") REFERENCES "auth"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;



ALTER TABLE ONLY "public"."local_posts"
    ADD CONSTRAINT "local_posts_local_fkey" FOREIGN KEY ("local") REFERENCES "public"."locals"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "Business" ON "public"."local_posts" TO "authenticated" USING ("public"."check_access"("local")) WITH CHECK ("public"."check_access"("local"));
...
CREATE POLICY "Customer select" ON "public"."local_posts" FOR SELECT USING ("public"."check_customer_access"());
...
GRANT ALL ON TABLE "public"."local_posts" TO "anon";
GRANT ALL ON TABLE "public"."local_posts" TO "authenticated";
GRANT ALL ON TABLE "public"."local_posts" TO "service_role";



GRANT ALL ON SEQUENCE "public"."local_posts_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."local_posts_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."local_posts_id_seq" TO "service_role";
...
CREATE POLICY "Business insert" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("public"."check_app_id"('app.beeloyal.employer'::"text") AND ("bucket_id" = 'local_posts'::"text")));
